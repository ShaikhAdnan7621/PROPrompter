            ...
            <section className="container mx-auto px-4 py-16 bg-white">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    ...
                    <div className="text-center">
                        <div className="bg-green-100 rounded-full p-4 mx-auto mb-4 flex justify-center gap-4 items-center">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-8 h-8 text-green-500">
                                <path strokeLinecap="round" strokeLinejoin="round" d="M12 6v12m-3-3h6m-3-3v6" />
                            </svg>
                            <h3 className="text-xl font-semibold text-gray-800">Diverse Prompts</h3>
                        </div>
                        <p className="text-gray-600 mt-2">
                            Explore a wide variety of prompt categories to spark your imagination.
                        </p>
                    </div>
                    ...
                    <div className="text-center">
                        <div className="bg-green-100 rounded-full p-4 mx-auto mb-4 flex justify-center gap-4 items-center">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-8 h-8 text-green-500">
                                <path strokeLinecap="round" strokeLinejoin="round" d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v8m8-8h8a2 2 0 012 2v6a2 2 0 01-2 2H6a2 2 0 01-2-2v-6a2 2 0 012-2h8z" />
                            </svg>
                            <h3 className="text-xl font-semibold text-gray-800">Easy to Use</h3>
                        </div>
                        <p className="text-gray-600 mt-2">
                            Our user-friendly interface makes it simple to find and use prompts.
                        </p>
                    </div>
                    ...
                    <div className="text-center">
                        <div className="bg-green-100 rounded-full p-4 mx-auto mb-4 flex justify-center gap-4 items-center">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-8 h-8 text-green-500">
                                <path strokeLinecap="round" strokeLinejoin="round" d="M12 9v3m0 0v3m0-3h3m-3 0h3m-3 0v3m3 0v3m-3 0h3m-3 0h3m-3 0v3m3-3h3m-3 0h3" />
                            </svg>
